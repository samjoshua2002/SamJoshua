    ...
    const cards = [
      {
        "id": 1,
        "category": "group",
        "image": "https://cdn.dribbble.com/users/1997192/screenshots/15359806/dribbble_final_post.png?compress=1&resize=400x300",// Use relative path
        ...
        "technologies": "HTML, JavaScript, React, Node.js, CSS, Redux",
        "links": [
          {
            "icon": <FaGithub />,
            "name": "Github",
